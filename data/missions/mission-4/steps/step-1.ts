...
export const mission4Step1: Step = {
  ...
  narrative: `« Mon radeau n'est pas assez résistant ! Cette fois-ci il me faut des lianes, mais elles sont trop hautes. Aide-moi à fabriquer le lance-grappin et je pourrais aller chercher les plus solides ! »`,
  location: "Sur la plage",
  raftPiece: "piece-4-1",
  raftObject: {
    image: "/missions/mission-4/step-1/M4_S2_popup-propulsion.webp",
    readAloudText:
  ...
  game: {
    ...
    tightDesktopQuestionLayout: true,
  },
};
