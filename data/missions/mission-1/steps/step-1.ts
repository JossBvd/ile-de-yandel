...
fabrication ! Bonne chance ! »`,
  ...
  raftPiece: "piece-1-1",
  raftObject: {
    image: "/missions/mission-1/step-1/M1_S1_popup-ficelle.webp",
    readAloudText: "Étape 1 accomplie. Tu as collecté : ficelle",
  },
  ...
  backgroundHintZones: [
    {
      ...
      readAloudText: "Indice: ce pantalon est déchiré (é)",
    },
    {
      x: 11.38,
      y: 33.46,
      ...
      readAloudText: "Indice: ces t-shirts sont déchirés (é - s)",
    },
    {
      x: 24.06,
      y: 64.92,
    ...
    },
    {
      ...
      readAloudText: "Indice: cette casquette est déchirée (é - e)",
    },
    {
      x: 65.35,
      y: 58.55,
    ...
    },
    {
      ...
      readAloudText: "Indice : ces robes sont déchirées (é-e-s)",
    },
    {
      x: 77.96,
      y: 84.61,
