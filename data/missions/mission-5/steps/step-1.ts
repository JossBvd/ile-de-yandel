...
export const mission5Step1: Step = {
  ...
  game: {
    type: "qcm",
    question: `Yandel suit la rivière qui descend de la montagne jusqu’à la mer. Il veut remplir sa gourde près de la mer, mais l’eau y est légèrement salée, alors que celle de la montagne ne l’était pas. Pourquoi ?`,
    options: [
      { id: "A", text: "L’eau douce s’évapore quand elle descend" },
      { id: "B", text: "Il y a beaucoup de sel dans la montagne" },
      { id: "C", text: "L’eau de la mer s’est mélangée à l’eau douce" },
      { id: "D", text: "L’eau de pluie a salé la rivière" },
    ],
    correctAnswers: [2],
